...
Mathlib PR #34106 (A. Dedecker, draft, "map a seminorm along a surjective linear map"), file
`Mathlib/Analysis/Normed/Group/QuotientSeminorm.lean`, defines `GroupSeminorm.map` along a
surjective group homomorphism and `GroupSeminorm.quotient`, with additive versions, and proves their
universal property and descent lemmas. The declarations of this file are the analogues for seminorms
over a normed field and a submodule; the docstrings name the corresponding declarations. They were
obtained independently. Once that PR is in the pinned Mathlib, consider deriving `Seminorm.quotient`
from the additive group version.
...
The group-seminorm analogue, the quotient by a normal subgroup, is `AddGroupSeminorm.quotient` of
Mathlib PR #34106 (A. Dedecker, draft), file `Mathlib/Analysis/Normed/Group/QuotientSeminorm.lean`
(generated by `to_additive`). The statement here is for seminorms over a normed field and a
submodule, and was obtained independently. -/
@[expose]
...
The group-seminorm analogue is `AddGroupSeminorm.quotient_coe_le` of Mathlib PR #34106 (A. Dedecker,
draft), file `Mathlib/Analysis/Normed/Group/QuotientSeminorm.lean` (generated by `to_additive`). The
statement here is for seminorms over a normed field and a submodule, and was obtained independently.
-/
...
The group-seminorm analogue is `AddGroupSeminorm.le_quotient_iff_comp_le` of Mathlib PR #34106 (A.
Dedecker, draft), file `Mathlib/Analysis/Normed/Group/QuotientSeminorm.lean` (generated by
`to_additive`). The statement here is for seminorms over a normed field and a submodule, and was
...
The group-seminorm analogue is `AddGroupSeminorm.quotient_mono` of Mathlib PR #34106 (A. Dedecker,
draft), file `Mathlib/Analysis/Normed/Group/QuotientSeminorm.lean` (generated by `to_additive`). The
statement here is for seminorms over a normed field and a submodule, and was obtained independently.
-/
...
The group-seminorm analogue is `AddGroupSeminorm.quotient_comp_eq` of Mathlib PR #34106 (A.
Dedecker, draft), file `Mathlib/Analysis/Normed/Group/QuotientSeminorm.lean` (generated by
`to_additive`). The statement here is for seminorms over a normed field and a submodule, and was
obtained independently. -/
...
The group-seminorm analogue is `AddGroupSeminorm.comp_quotient_eq` of Mathlib PR #34106 (A.
Dedecker, draft), file `Mathlib/Analysis/Normed/Group/QuotientSeminorm.lean` (generated by
`to_additive`). The statement here is for seminorms over a normed field and a submodule, and was
obtained independently. -/
...
The group-seminorm analogue is one direction of `AddGroupSeminorm.quotient_lt_iff` of Mathlib PR
#34106 (A. Dedecker, draft), file `Mathlib/Analysis/Normed/Group/QuotientSeminorm.lean` (generated
by `to_additive`). The statement here is for seminorms over a normed field and a submodule, and was
obtained independently. -/

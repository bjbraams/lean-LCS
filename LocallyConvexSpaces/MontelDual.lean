...
convergence on an equicontinuous family, and Montel identifies compact and strong convergence.
Consequently the strong dual of a quasi-barrelled Montel space is Montel.

Mathlib's Montel convention does not include barrelledness. The explicit quasi-barrelledness
assumption supplies equicontinuity of strongly bounded sets. This independently formalizes
the strong-dual conclusion of Schaefer–Wolff IV, Theorem 5.9, with quasi-barrelledness stated explicitly.
-/
...
theorem StrongDual.isCompact_polar_of_montel {U : Set E} (hU : U ∈ 𝓝 (0 : E)) :
...
For barrelled Montel spaces this is Schaefer–Wolff IV, Theorem 5.9; the proof independently
uses Mathlib's Arzelà–Ascoli theorem and the project's Alaoglu–Bourbaki theorem. -/
theorem MontelSpace.strongDual [Module ℝ E] [IsScalarTower ℝ 𝕜 E]
  ...
  exact (StrongDual.isCompact_polar_of_montel hU).of_isClosed_subset hclosed hHU
